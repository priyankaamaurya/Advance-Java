...
public class First {
	...
	public static void main(String[] args) {
		...
		try {
			...
			statement.execute("create table third (a numeric primary key , b varchar);");
...
// create 5 tables in jdbc and enter 15 data  and update 15 data and 15 delete the data in jdbc
